...
class ModeloInventarios
{
  ...
  static public function mdlInfoInventarios()
  {
    $stmt = Conexion::conectar()->prepare("SELECT * FROM  inventario_hangar");
    $stmt->execute();
  ...
  static public function mdlRegInventarios($data)
  {

    $desInventario = $data["desInventario"];
    $pnInventario = $data["pnInventario"];
    $snInventario = $data["snInventario"];
    $qtyInventario = $data["qtyInventario"];
    $ubicacionInventario = $data["ubicacionInventario"];
    $custodiaInventario = $data["custodiaInventario"];
    $fechadeinspInventario = $data["fechadeinspInventario"];
    $periodoinspInventario = $data["periodoinspInventario"];
    $fechaproxinspInventario = $data["fechaproxinspInventario"];
    $estadoInventario = $data["estadoInventario"];
    $diasalertaInventario = $data["diasalertaInventario"];
    $observacionesInventario = $data["observacionesInventario"];
    $tareasarealizarInventario = $data["tareasarealizarInventario"];

    $stmt = Conexion::conectar()->prepare("insert into inventario_hangar(descripcion_inventario, pn_inventario, sn_cod_inventario, qty_inventario, ubicacion_inventario, custodia_inventario, fecha_de_inspeccion_inventario, periodo_inspeccion_inventario, fecha_prox_inspeccion_inventario, estado_inventario, dias_alerta_inventario, observaciones_inventario, tareas_a_realizar) values('$desInventario', '$pnInventario', '$snInventario', '$qtyInventario', '$ubicacionInventario', '$custodiaInventario', '$fechadeinspInventario', '$periodoinspInventario', '$fechaproxinspInventario', '$estadoInventario', '$diasalertaInventario', '$observacionesInventario', '$tareasarealizarInventario')");
