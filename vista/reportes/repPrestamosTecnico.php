...
$pdf->Cell(10, 7, 'CANT.', 1, 0, 'C');
$pdf->Cell(20, 7, utf8_decode('# DE PARTE'), 1, 0, 'C');
...
foreach($reporte["calibradas"] as $value){
  ...
  foreach($producto as $prd){
    ...
    $pdf->Cell(10, 7, $prd["cantidad"], 1, 0, 'C');
    $pdf->Cell(20, 7, $herramienta["pn_controlherramientas"], 1, 0, 'C');
    $pdf->Cell(35, 7, $herramienta["numserie_controlherramientas"], 1, 0, 'C');
    $pdf->Cell(70, 7, $herramienta["descripcion_controlherramientas"], 1, 0, 'C');
