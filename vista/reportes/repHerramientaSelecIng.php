...
$pdf->Cell(42, 8, utf8_decode('DESCRIPTION'), 1, 0, 'C', true);
...
$pdf->Cell(35, 8, utf8_decode('BRAND OR MANUF.'), 1, 0, 'C', true);
$pdf->Cell(10, 8, utf8_decode('AMT.'), 1, 0, 'C', true);
$pdf->Cell(25, 8, utf8_decode('UBICATION'), 1, 0, 'C', true);
$pdf->Cell(20, 8, utf8_decode('EXP. DATE'), 1, 0, 'C', true);
$pdf->Cell(23, 8, utf8_decode('SIGNATURE'), 1, 1, 'C', true);
